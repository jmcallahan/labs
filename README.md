...
- Built a standardized Windows desktop VM using thin-provisioned storage, installed the OS and guest tools, and corrected VM time drift via host synchronization. Focused on why time drift causes real authentication and logging failures, how guest tools mitigate it, and how to document a clean, repeatable build with evidence.
